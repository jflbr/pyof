...
_cfg_file    = os.path.join(_current_dir, "../examples/application.json")
...
class TestConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_reader = config.LocalConfigReader(_cfg_file)
    ...
    def test_store(self):
        ...
        self.config_reader.store('tests/generated/test_store_with_OfObjects.Sasuke.Objects.shortweapon.damage_value_is_2000.json')
        self.config.set_value('Objects.shortweapon.damage', 5000)
        self.config_reader.store('tests/generated/test_store_with_Sasuke.shortweapon.damage_is_5000.json' )
